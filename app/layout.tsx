...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Sydney tiling contractor",
    "tiling services Sydney NSW",
    "North Sydney tiler",
    "Eastern Suburbs tiler",
    "Inner West tiler Sydney",
    "Northern Beaches tiler",
    "Inner West tiler Sydney",
    "Eastern Suburbs tiler",
    "North Sydney tiler",
    "Parramatta tiler",
    "Cronulla tiler",
    "tiler Sutherland Shire",
    "Hills District tiling",
    "porcelain tiling Sydney",
    "ceramic tiling experts",
    "stone supply and install Sydney",
    "travertine pavers Sydney",
    "balcony waterproofing Sydney",
    "leaking shower repair Sydney",
    "bathroom renovation cost Sydney",
    "luxury bathroom tiling",
  ],
